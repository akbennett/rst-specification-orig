...
project = u'Product Specification'
copyright = u'2016, url.org'
author = u'url.org'
...
# of the sidebar.
html_logo = "main-logo.png"

# The name of an image file (relative to this directory) to use as a favicon of
# the docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = "main-favicon.png"
...
latex_documents = [
    (master_doc, 'rst-specification.tex', u'Product Specification',
     u'url.org', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = "main-logo.png"
...
man_pages = [
    (master_doc, 'rst-specification', u'Product Specification',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'rst-specification', u'Product Specification',
     author, 'RSTSpecification', 'Product development specification.',
     'Miscellaneous'),
]
